...
class CustomersService:
    ...
    def create(cls, data: CustomersCreate) -> CustomersResponse:
        customer = CustomerRepository.get_optional_first(
    ...
    def edit(cls, data: CustomersEdit) -> CustomersResponse:
        customer = CustomerRepository.get_first(CustomersFilter(id=data.id))
        customer = CustomerRepository.edit(customer, data)
        return CustomersResponse.from_model(customer)
